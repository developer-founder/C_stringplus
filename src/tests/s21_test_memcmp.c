...
START_TEST(test_memcmp_int_array_equal) {
  ...
  ck_assert_int_eq(s21_memcmp(arr1, arr2, 5 * sizeof(int)),
...
START_TEST(test_memcmp_double_array) {
  ...
  ck_assert_int_eq(s21_memcmp(arr1, arr2, 3 * sizeof(double)),
                   memcmp(arr1, arr2, 3 * sizeof(double)));

  ck_assert_int_eq(s21_memcmp(arr1, arr3, 3 * sizeof(double)),
                   memcmp(arr1, arr3, 3 * sizeof(double)));
}
END_TEST
...
START_TEST(test_memcmp_misaligned_pointers) {
  ...
  ck_assert_int_eq(s21_memcmp(buffer + 3, buffer + 10, 20),
                   memcmp(buffer + 3, buffer + 10, 20));
}
END_TEST
...
START_TEST(test_memcmp_pattern) {
  ...
  ck_assert_int_eq(s21_memcmp(buffer1, buffer2, 100),
                   memcmp(buffer1, buffer2, 100));
}
END_TEST
...
START_TEST(test_memcmp_reverse_order) {
  ...
  ck_assert_int_eq((result1 > 0 && result2 < 0) || (result1 < 0 && result2 > 0),
                   1);
}
END_TEST
